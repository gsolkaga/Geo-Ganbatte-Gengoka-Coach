...
|---|---|---|---|---|---|---|
| gpt-oss-120b | 10 | 2 | 1 | 11 | 2 | 0 |
| gemma-4-31B-it | 5 | 7 | 1 | 2 | 11 | 0 |
| Qwen3.6-35B-A3B | 9 | 4 | 0 | 10 | 3 | 0 |
| Kimi-K2.6 | 11 | 1 | 1 | 10 | 3 | 0 |
...
| q-za-01 | preview/Kimi-K2.6 | true | 0 | — | — |
...
|---|---|---|---|---|---|---|
| q-jp-01 | gpt-oss-120b | 2 | 同一 | ok / truncated | 0 / 0 | **ちがう** |
| q-jp-01 | preview/gemma-4-31B-it | 2 | 同一 | truncated / ok | — / 0 | **ちがう** |
| q-jp-01 | preview/Qwen3.6-35B-A3B | 2 | 同一 | ok / ok | 0 / 0 | 一致 |
...
| q-is-01 | preview/Qwen3.6-35B-A3B | 2 | 同一 | truncated / truncated | — / — | 一致 |
| q-is-01 | preview/Kimi-K2.6 | 2 | 同一 | truncated / ok | — / 0 | **ちがう** |
| q-kz-01 | gpt-oss-120b | 2 | 同一 | ok / ok | 1 / 1 | 一致 |
| q-kz-01 | preview/gemma-4-31B-it | 2 | 同一 | truncated / truncated | — / — | 一致 |
| q-kz-01 | preview/Qwen3.6-35B-A3B | 2 | 同一 | ok / ok | 0 / 1 | **ちがう** |
| q-kz-01 | preview/Kimi-K2.6 | 2 | 同一 | ok / ok | 0 / 1 | **ちがう** |

**入力が同一の組: 12 / 12**

**status がちがった組: 3 / 12**　**見落とし件数がちがった組: 4 / 12**
